...
namespace KKS_RandomStatus
{
    ...
    public class KKS_RandomStatus : BaseUnityPlugin
    {
        ...
        void Awake()
        {
            ...
            if (method != null)
            {
                harmony.Patch(method, postfix: new HarmonyMethod(typeof(KKS_RandomStatus), nameof(GlobalPostfix)));
            }
        }
        ...
        static void GlobalPostfix(Cycle __instance)
        {
            ...
            UnityEngine.Debug.Log($"【KKS_RandomStatus】Start of time-based processing: {__instance.nowType}");
        ...
        static void AllGirlRandomizer()
        {
            ...
            UnityEngine.Debug.Log($"Made {countL} lover");
            UnityEngine.Debug.Log($"Made {countFL} full lover");
